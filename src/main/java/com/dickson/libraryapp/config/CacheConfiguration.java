package com.dickson.libraryapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.dickson.libraryapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.dickson.libraryapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
