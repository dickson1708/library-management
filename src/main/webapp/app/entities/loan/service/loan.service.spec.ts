...
const requireRestSample: RestLoan = {
  ...
  returnDate: sampleWithRequiredData.returnDate?.toJSON(),
};
...
describe('Loan Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Loan', () => {
      ...
      service.create(loan).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Loan', () => {
      ...
      service.update(loan).subscribe(resp => (expectedResult = resp));
    ...
    describe('addLoanToCollectionIfMissing', () => {
      it('should add a Loan to an empty array', () => {
        ...
        expect(expectedResult).toEqual([loan]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([loan, loan2]);
      });
