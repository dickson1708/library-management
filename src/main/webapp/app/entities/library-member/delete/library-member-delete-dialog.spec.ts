...
import { LibraryMemberDeleteDialog } from './library-member-delete-dialog';

describe('LibraryMember Management Delete Component', () => {
  let comp: LibraryMemberDeleteDialog;
  let fixture: ComponentFixture<LibraryMemberDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(LibraryMemberDeleteDialog);
