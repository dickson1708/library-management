...
describe('Book Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Book', () => {
      ...
      service.create(book).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Book', () => {
      ...
      service.update(book).subscribe(resp => (expectedResult = resp));
    ...
    describe('addBookToCollectionIfMissing', () => {
      it('should add a Book to an empty array', () => {
        ...
        expect(expectedResult).toEqual([book]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([book, book2]);
      });
