...
describe('Review Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Review', () => {
      ...
      service.create(review).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Review', () => {
      ...
      service.update(review).subscribe(resp => (expectedResult = resp));
    ...
    describe('addReviewToCollectionIfMissing', () => {
      it('should add a Review to an empty array', () => {
        ...
        expect(expectedResult).toEqual([review]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([review, review2]);
      });
